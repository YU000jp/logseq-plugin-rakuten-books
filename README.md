...
- プラグインによって書籍名ページ作成が実行される

### 読書メモをとる

- [Option 1] 日誌などの他のページからからリンクやタグ(`#[[本/タイトル]]`あるいは`#[[電子書籍/タイトル]]`)をつけて、入れ子にする

- [Option 2] 書籍名ページに直接書く (この場合、日付リンクをつけると後からいつ書いたのかが分かるので便利です)

- [Option 3] 書籍名ページのサブページを作成し、そのページに書く (サブページの例：`本/タイトル/感想`)
...
- 各書籍名ページ (`本/タイトル`もしくは`電子書籍/タイトル`のような形式)
